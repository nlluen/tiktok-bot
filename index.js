...
class Downloader {
    ...
    get = async () => {
        ...
        this.datas = {video:video}; //this.datas = {video:video,music:music,author:author};
    }
    ...
    request(
        {
          ...
          function(err, httpResponse) {
            ...
            console.log(httpResponse.headers.location || shorturl)
          }
    )
}
...
client.on('message', message =>{
    ...
    const TikTok = new Downloader(message);

    TikTok.get().then(function(){
        let test = TikTok.download_video();
